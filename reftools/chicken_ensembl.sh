...
#
# Build a chicken reference jar from scratch using info from the current
...
shift
ENSEMBL_VER=61
ENSEMBL_PREFIX=Gallus_gallus.WASHUC2.$ENSEMBL_VER
ENSEMBL_ORGANISM=ggallus
ENSEMBL_FTP=ftp://ftp.ensembl.org/pub/release-$ENSEMBL_VER/fasta/gallus_gallus/dna
INDEX=chicken_ensembl_${ENSEMBL_VER}$SUFFIX
SIMPLE_NAME=$INDEX
...
BASE_CHRS="$BASE_CHRS chromosome.32 chromosome.MT chromosome.W chromosome.Z nonchromosomal"
