...
#
# Build a rhesus reference jar from scratch using info from the current
...
INDEX=rhesus_ensembl_${ENSEMBL_VER}$SUFFIX
SIMPLE_NAME=$INDEX
...
BASE_CHRS="$BASE_CHRS chromosome.X chromosome.MT nonchromosomal"
